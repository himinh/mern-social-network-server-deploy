...
router.route('/').post((0, _middlewares.auth)(), _middlewares.uploadStorage.single('image'), _middlewares.uploadPostImage, (0, _middlewares.validate)(_validations.postValidation.createPost), _controllers.postController.createPost).get((0, _middlewares.auth)(), (0, _middlewares.validate)(_validations.postValidation.getPosts), _controllers.postController.getPosts);
router.get('/profile', (0, _middlewares.auth)(), (0, _middlewares.validate)(_validations.postValidation.getPosts), _controllers.postController.getProfilePosts);
