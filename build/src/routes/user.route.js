...
router.route('/').post( // auth('admin'),
(0, _middlewares.validate)(_validations.userValidation.createUser), _controllers.userController.createUser).get((0, _middlewares.auth)(), (0, _middlewares.validate)(_validations.userValidation.getUsers), _controllers.userController.getUsers);
