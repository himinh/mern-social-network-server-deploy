...
router.patch('/:chatId/readBy', (0, _middlewares.auth)(), (0, _middlewares.validate)(_validations.messageValidation.addToReadBy), _controllers.messageController.addToReadBy);
